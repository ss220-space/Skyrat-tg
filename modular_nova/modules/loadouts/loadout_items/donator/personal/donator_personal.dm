...
/datum/loadout_item/shoes/rax_armadyne_boots
	...
	restricted_roles = list(JOB_BLUESHIELD, JOB_NT_REP, JOB_CAPTAIN, JOB_VETERAN_ADVISOR, JOB_HEAD_OF_SECURITY, JOB_SECURITY_OFFICER, JOB_WARDEN, JOB_DETECTIVE, JOB_CORRECTIONS_OFFICER)
