...
/obj/item/clothing/head/helmet/space/hev_suit
	...
	icon = 'modular_ss220/reverts/return_prs/icons/hev_suit/helmeq.dmi'
	worn_icon = 'modular_ss220/reverts/return_prs/icons/hev_suit/helmet.dmi'
	icon_state = "hev"
	...
	clothing_flags = STOPSPRESSUREDAMAGE|THICKMATERIAL|SNUG_FIT|LAVAPROTECT|BLOCK_GAS_SMOKE_EFFECT|HEADINTERNALS
...
/obj/item/clothing/suit/space/hev_suit
	...
	icon = 'modular_ss220/reverts/return_prs/icons/hev_suit/hevsuiteq.dmi'
	worn_icon = 'modular_ss220/reverts/return_prs/icons/hev_suit/hevsuit.dmi'
	worn_icon_digi = 'modular_ss220/reverts/return_prs/icons/hev_suit/hevsuit_digi.dmi'
	icon_state = "hev"
	...
	///Lots of sound vars.
	var/activation_song = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/anomalous_materials.ogg'

	var/logon_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/01_hev_logon.ogg'
	var/armor_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/02_powerarmor_on.ogg'
	var/atmospherics_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/03_atmospherics_on.ogg'
	var/vitalsigns_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/04_vitalsigns_on.ogg'
	var/automedic_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/05_automedic_on.ogg'
	var/weaponselect_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/06_weaponselect_on.ogg'
	var/munitions_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/07_munitionview_on.ogg'
	var/communications_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/08_communications_on.ogg'
	var/safe_day_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/09_safe_day.ogg'

	var/batt_50_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/power_level_is_fifty.ogg'
	var/batt_40_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/power_level_is_fourty.ogg'
	var/batt_30_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/power_level_is_thirty.ogg'
	var/batt_20_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/power_level_is_twenty.ogg'
	var/batt_10_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/power_level_is_ten.ogg'

	var/near_death_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/near_death.ogg'
	var/health_critical_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/health_critical.ogg'
	var/health_dropping_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/health_dropping2.ogg'

	var/blood_loss_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/blood_loss.ogg'
	var/blood_toxins_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/blood_toxins.ogg'
	var/biohazard_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/biohazard_detected.ogg'
	var/chemical_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/chemical_detected.ogg'
	var/radiation_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/radiation_detected.ogg'

	var/minor_fracture_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/minor_fracture.ogg'
	var/major_fracture_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/major_fracture.ogg'
	var/minor_lacerations_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/minor_lacerations.ogg'
	var/major_lacerations_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/major_lacerations.ogg'

	var/morphine_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/morphine_shot.ogg'
	var/wound_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/wound_sterilized.ogg'
	var/antitoxin_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/antitoxin_shot.ogg'
	var/antidote_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/antidote_shot.ogg'
...
/datum/action/item_action/hev_toggle
	...
	button_icon = 'modular_ss220/reverts/return_prs/icons/hev_suit/toggles.dmi'
...
/datum/action/item_action/hev_toggle_notifs/Trigger(trigger_flags)
	...
	playsound(my_suit, 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/blip.ogg', 50)
...
/obj/item/clothing/suit/space/hev_suit/proc/stat_changed(datum/source, new_stat)
	SIGNAL_HANDLER
	if(new_stat == DEAD)
		playsound(src, 'modular_ss220/reverts/return_prs/sound/hev_suit/hev/flatline.ogg', 40)
...
/obj/item/clothing/suit/space/hev_suit/pcv
	...
	logon_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/01_pcv_logon.ogg'
	armor_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/02_powerarmor_on.ogg'
	atmospherics_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/03_atmospherics_on.ogg'
	vitalsigns_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/04_vitalsigns_on.ogg'
	automedic_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/05_automedic_on.ogg'
	weaponselect_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/06_weaponselect_on.ogg'
	munitions_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/07_munitionview_on.ogg'
	communications_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/08_communications_on.ogg'
	safe_day_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/09_safe_day.ogg'

	batt_50_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/power_level_is_fifty.ogg'
	batt_40_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/power_level_is_fourty.ogg'
	batt_30_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/power_level_is_thirty.ogg'
	batt_20_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/power_level_is_twenty.ogg'
	batt_10_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/ten.ogg'

	near_death_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/near_death.ogg'
	health_critical_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/health_critical.ogg'
	health_dropping_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/health_dropping2.ogg'

	blood_loss_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/blood_loss.ogg'
	blood_toxins_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/blood_toxins.ogg'
	biohazard_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/biohazard_detected.ogg'
	chemical_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/chemical_detected.ogg'

	minor_fracture_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/minor_fracture.ogg'
	major_fracture_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/major_fracture.ogg'
	minor_lacerations_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/minor_lacerations.ogg'
	major_lacerations_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/major_lacerations.ogg'

	morphine_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/morphine_shot.ogg'
	wound_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/wound_sterilized.ogg'
	antitoxin_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/antitoxin_shot.ogg'
	antidote_sound = 'modular_ss220/reverts/return_prs/sound/hev_suit/pcv/antidote_shot.ogg'
