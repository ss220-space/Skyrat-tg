/datum/looping_sound/lambda
	mid_sounds = list('modular_ss220/reverts/return_prs/sound/black_mesa/lc_mainbeam.ogg' = 1)
...
/obj/effect/bump_teleporter/lambda/teleport_action(atom/movable/target, turf/destination)
	...
	playsound(src, 'modular_ss220/reverts/return_prs/sound/black_mesa/lc_teleport.ogg', 100)
