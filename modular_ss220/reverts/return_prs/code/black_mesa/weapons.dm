/obj/item/crowbar/freeman
	...
	icon = 'modular_ss220/reverts/return_prs/icons/black_mesa/misc/freeman.dmi'
	icon_state = "crowbar"
	force = 35
	throwforce = 45
	toolspeed = 0.1
...
/obj/item/shield/riot/pointman/hecu
	...
	icon = 'modular_ss220/reverts/return_prs/icons/black_mesa/misc/ballistic.dmi'
	worn_icon_state = "ballistic_worn"
	worn_icon = 'modular_ss220/reverts/return_prs/icons/black_mesa/misc/ballistic.dmi'
	inhand_icon_state = "ballistic"
	lefthand_file = 'modular_ss220/reverts/return_prs/icons/black_mesa/misc/ballistic_l.dmi'
	righthand_file = 'modular_ss220/reverts/return_prs/icons/black_mesa/misc/ballistic_r.dmi'
	force = 14
	throwforce = 5
	throw_speed = 1
	throw_range = 1
