/mob/living/simple_animal/hostile/blackmesa/xen/nihilanth
	name = "nihilanth"
	desc = "Holy shit."
	icon = 'modular_ss220/reverts/return_prs/icons/black_mesa/nihilanth.dmi'
...
/mob/living/simple_animal/hostile/blackmesa/xen/nihilanth/Aggro()
	...
	if(!(world.time <= alert_cooldown_time))
		...
		switch(health)
			if(0 to 999)
				playsound(src, pick(list('modular_ss220/reverts/return_prs/sound/black_mesa/mobs/nihilanth/nihilanth_pain01.ogg', 'modular_ss220/reverts/return_prs/sound/black_mesa/mobs/nihilanth/nihilanth_freeeemmaan01.ogg')), 100)
			if(1000 to 2999)
				playsound(src, pick(list('modular_ss220/reverts/return_prs/sound/black_mesa/mobs/nihilanth/nihilanth_youalldie01.ogg', 'modular_ss220/reverts/return_prs/sound/black_mesa/mobs/nihilanth/nihilanth_deceiveyou01.ogg')), 100)
			if(3000 to 6000)
				playsound(src, pick(list('modular_ss220/reverts/return_prs/sound/black_mesa/mobs/nihilanth/nihilanth_whathavedone01.ogg', 'modular_ss220/reverts/return_prs/sound/black_mesa/mobs/nihilanth/nihilanth_deceiveyou01.ogg')), 100)
			else
				playsound(src, pick(list('modular_ss220/reverts/return_prs/sound/black_mesa/mobs/nihilanth/nihilanth_thetruth01.ogg', 'modular_ss220/reverts/return_prs/sound/black_mesa/mobs/nihilanth/nihilanth_iamthelast01.ogg')), 100)
