/mob/living/simple_animal/hostile/blackmesa/xen/headcrab
	...
	alert_sounds = list(
		'modular_ss220/reverts/return_prs/sound/black_mesa/mobs/headcrab/alert1.ogg'
	)
	var/is_zombie = FALSE
...
/mob/living/simple_animal/hostile/blackmesa/xen/headcrab/Shoot(atom/targeted_atom)
	...
	playsound(
		src,
		pick('modular_ss220/reverts/return_prs/sound/black_mesa/mobs/headcrab/attack1.ogg', 'modular_ss220/reverts/return_prs/sound/black_mesa/mobs/headcrab/attack2.ogg', 'modular_ss220/reverts/return_prs/sound/black_mesa/mobs/headcrab/attack3.ogg'),
		100
		)
...
/mob/living/simple_animal/hostile/blackmesa/xen/headcrab/death(gibbed)
	...
	playsound(src, pick(list(
		'modular_ss220/reverts/return_prs/sound/black_mesa/mobs/headcrab/die1.ogg',
		'modular_ss220/reverts/return_prs/sound/black_mesa/mobs/headcrab/die2.ogg'
	)), 100)
...
/mob/living/simple_animal/hostile/blackmesa/xen/headcrab/throw_impact(atom/hit_atom, datum/thrownthing/throwingdatum)
	...
	if(!isliving(hit_atom))
		return
	playsound(src, 'modular_ss220/reverts/return_prs/sound/black_mesa/mobs/headcrab/headbite.ogg', 100)
...
/mob/living/simple_animal/hostile/blackmesa/xen/headcrab/update_overlays()
	...
	if(is_zombie)
		...
		var/mutable_appearance/blob_head_overlay = mutable_appearance('modular_ss220/reverts/return_prs/icons/black_mesa/mobs.dmi', "headcrab_zombie")
