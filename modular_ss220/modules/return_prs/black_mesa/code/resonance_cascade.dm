...
/datum/round_event/portal_storm/resonance_cascade/announce(fake)
	set waitfor = 0
	sound_to_playing_players('modular_ss220/modules/return_prs/black_mesa/sound/tc_12_portalsuck.ogg')
	sleep(40)
	...
	sleep(20)
	sound_to_playing_players('modular_ss220/modules/return_prs/black_mesa/sound/tc_13_teleport.ogg')
